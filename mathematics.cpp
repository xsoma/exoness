...
namespace math {
	...
	void rotate_movement(float yaw) {
		...
		float new_forwardmove = (cos_rot * game::main.get_command()->forwardmove) - (sin_rot * game::main.get_command()->sidemove);
		float new_sidemove = (sin_rot * game::main.get_command()->forwardmove) + (cos_rot * game::main.get_command()->sidemove);

		game::main.get_command()->forwardmove = new_forwardmove;
		game::main.get_command()->sidemove = new_sidemove;
	}
	//--------------------------------------------------------------------------------
