...
void old_ui::draw_misc_tab(int& current_players_esp_subtab, int tab_amount, Vector _pos, int MenuAlpha_Main)
{
	...
	static std::string ESP_Player_SubTabs_Names[2] = { "main", "other" };
	...
	for (int i = 0; i < tab_amount; i++)
	{
		...
		int tab_area[4] = {
			...
			(in_sizew_esp_player_subtabs / tab_amount) - 2, 24
		};
