...
void old_ui::draw_aimbot_tab(int& current_players_esp_subtab, int tab_amount, Vector _pos, int MenuAlpha_Main)
{
	...
	static std::string ESP_Player_SubTabs_Names[4] = { "main", "accuracy", "antiaim", "misc" };
