...
void ImGui_ImplDX9_RenderDrawLists(ImDrawData* draw_data)
{
	...
	D3DXMatrixOrthoOffCenterLH(&mat, 0.5f, ui::GetIO().DisplaySize.x + 0.5f, ui::GetIO().DisplaySize.y + 0.5f, 0.5f, -1.0f, +1.0f);
...
bool ImGui_ImplDX9_Init(void* hwnd, IDirect3DDevice9 * devices)
{
	g_hWnd = (HWND)hwnd;
	g_pd3dDevice = devices;
...
void ImGui_ImplDX9_InvalidateDeviceObjects()
{
	...
	if (LPDIRECT3DTEXTURE9 tex = (LPDIRECT3DTEXTURE9)ui::GetIO().Fonts->TexID)
	{
		tex->Release();
		ui::GetIO().Fonts->TexID = 0;
	}
	g_FontTexture = NULL;
}
