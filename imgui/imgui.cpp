...
ImGuiIO::ImGuiIO()
{
    ...
    IniSavingRate = 5.0f;
    IniFilename = "stylescheat.settings";
...
int ImFormatString1(char* buf, int buf_size, const char* fmt, ...) {
            ...
            if (!(flags & ImGuiWindowFlags_NoBackground))
            {
                if (!(flags & ImGuiWindowFlags_ChildWindow) && !(flags & ImGuiWindowFlags_Popup) && !(flags & ImGuiWindowFlags_Tooltip)) {
                    ...
                    if (flags & ImGuiWindowFlags_ChildWindow && !(flags & ImGuiWindowFlags_ChildFrame) && !(flags & ImGuiWindowFlags_Tooltip)) {
                        ...
                        int alpha = alp;
                        ImU32 bg_col = ImColor(40, 40, 40, 255);
                        ImU32 rect_col = ImColor(153, 51, 204, alpha);
                        ...
                        window->DrawList->AddRect(window->Pos + ImVec2(0, window->TitleBarHeight()), window->Pos + window->Size, rect_col, window_rounding);
                    }
                    else if (flags & ImGuiWindowFlags_Popup || flags & ImGuiWindowFlags_Tooltip || flags & ImGuiWindowFlags_ChildFrame) {
                        ImU32 bg_col = ImColor(40 / 255.f, 40 / 255.f, 40 / 255.f, g.Style.Alpha);
                        float alpha = 1.0f;
                        if (g.NextWindowData.BgAlphaCond != 0)
                            alpha = g.NextWindowData.BgAlphaVal;
                        if (alpha != 1.0f)
...
void ui::End()
{
   ...
   /* if (window->Flags & ImGuiWindowFlags_ChildWindow && !(window->Flags & ImGuiWindowFlags_ChildFrame)) {
        window->DrawList->AddRectFilledMultiColor(window->Pos + ImVec2(2, 2), window->Pos + ImVec2(window->Size.x - 6, 20),
            ImColor(30 / 255.f, 30 / 255.f, 30 / 255.f, g.Style.Alpha),
            ImColor(30 / 255.f, 30 / 255.f, 30 / 255.f, g.Style.Alpha),
            ImColor(30 / 255.f, 30 / 255.f, 30 / 255.f, 0.f),
            ImColor(30 / 255.f, 30 / 255.f, 30 / 255.f, 0.f));
