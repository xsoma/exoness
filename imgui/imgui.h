...
namespace ui
{
    ...
    IMGUI_API bool          MultiSelect(const char* label, std::unordered_map<int, bool>* data, std::vector<const char*> items);
    ...
    IMGUI_API bool          ColorButton(const char* desc_id, ImVec4& col, ImGuiColorEditFlags flags = 0, ImVec2 size = ImVec2(0,0));  // display a colored square/button, hover for details, return true when pressed.
    ...
    IMGUI_API void          TabButton_litt(const char* label, int* currenttab, int number, int total);
